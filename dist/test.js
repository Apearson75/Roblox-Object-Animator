...
const color2 = new properties_1.Color3(200, 230, 123);
...
const animation = new Animation_1.Animation(file, 0, 5, Animation_1.AnimationProperties.Color3, Animation_1.EasingStyles.Expo, final);
const animation2 = new Animation_1.Animation(file, 2, 6, Animation_1.AnimationProperties.CFrame, Animation_1.EasingStyles.Expo, final2);
const animation3 = new Animation_1.Animation(file, 5, 5, Animation_1.AnimationProperties.Color3, Animation_1.EasingStyles.Expo, color2);
